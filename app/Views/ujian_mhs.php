    ...
    <?php if($bank_soal): ?>
        ...
        <div class="jumbotron">
            ...
            <div class="form-check disabled">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optradio" disabled><?= $soal['option_c']; ?>
                </label>
            </div>

            <div class="form-check disabled">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optradio" disabled><?= $soal['option_d']; ?>
                </label>
            </div>
