      ...
      <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center" >
              ...
              <a href="<?= base_url('public/infoprodi/inf')?>" class="btn btn-primary">See Profile</a>
        ...
        <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center">
              ...
              <a href="<?= base_url('public/infoprodi/psi')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card" style="width:200px">
           ...
           <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS HUMANIORA DAN BISNIS</p>
              <a href="<?= base_url('public/infoprodi/mnj')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
        ...
        <div class="card" style="width:200px">
           ...
           <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS TEKNOLOGI DAN DESAIN</p>
              <a href="<?= base_url('public/infoprodi/sif')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
  <div>
  ...
  <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center" >
              ...
              <p class="card-text">FAKULTAS HUMANIORA DAN BISNIS</p>
              <a href="<?= base_url('public/infoprodi/akt')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS TEKNOLOGI DAN DESAIN</p>
              <a href="<?= base_url('public/infoprodi/arsi')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card" style="width:200px">
           ...
           <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS TEKNOLOGI DAN DESAIN</p>
              <a href="<?= base_url('public/infoprodi/dkv')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
        ...
        <div class="card" style="width:200px">
           ...
           <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS TEKNOLOGI DAN DESAIN</p>
              <a href="<?= base_url('public/infoprodi/dp')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
    ...
    <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center" >
              ...
              <p class="card-text">FAKULTAS HUMANIORA DAN BISNIS</p>
              <a href="<?= base_url('public/infoprodi/ilkom')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="card" style="width:200px">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">FAKULTAS TEKNOLOGI DAN DESAIN</p>
              <a href="<?= base_url('public/infoprodi/teksip')?>" class="btn btn-primary">See Profile</a>
            </div>
          </div>
        </div>
  <div>
...
<div class="row" style="text-align: center">
        <div class="col">
  <a href="<?= base_url('public/mahasiswa/daf_user')?>" class='btn btn-outline-info btn-lg center-block'>Mulai Ujian</a>
  </div>
  </div>
  </div>
