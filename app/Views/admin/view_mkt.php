		...
		<div class="sidebar-items">
			<div class="accordion" id="sidebar-items">
				<ul>
					...
					<li>
						<a href="<?= base_url('public/admin/masteradmin/index')?>" class="items">
	...
	<div class="content transition">
		<div class="container-fluid dashboard">
			...
			<div class="container mt-5">
                    ...
                    <a href="<?= base_url('public/admin/mastermkt/create')?>" class="btn btn-success mb-2">Add User</a>
                    <div class="row mt-3">
                        <div class="col-sm-12">
                                ...
                                <?php if ($marketing) : ?>
                                    <?php foreach ($marketing as $mkt) : ?>
                                        <tr>
                                            ...
                                            <td><?= $mkt['username']; ?></td>         
                                            <td>
                                                <a href="<?= base_url('public/admin/mastermkt/edit/' . $mkt['id_marketing']); ?>" class="btn btn-success">Edit</a>
                                                <a href="<?= base_url('public/admin/mastermkt/delete/' . $mkt['id_marketing']); ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
